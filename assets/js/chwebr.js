...
jQuery(document).ready(function ($) {
     ...
     *
     */
    function chwebr_check_cache() {
        setTimeout(function () {
            if (typeof(chwebr) && chwebr.refresh == "1") {
                chwebr_update_cache();
     ...
     * Deprecated
     */
    /*if (typeof('chwebr') && chwebr.restapi == "1"){
     chwebr_restapi_check_cache();
     }
     else if (typeof('chwebr') && chwebr.restapi == "0"){
     chwebr_check_cache_ajax();
     }*/
    /**
     * Check Cache via ajax endpoint
     *
     */
    function chwebr_check_cache_ajax() {

        setTimeout(function () {

            var data = {
                action: 'chwebr_refresh_cache',
            };
     ...
     *
     */
    function chwebr_restapi_check_cache() {

        setTimeout(function () {

            var data = {};
            var chweb_rest_url = 'http://src.wordpress-develop.dev/wp-json/chwebsocialshare/v1/verifycache/';
            $.get(chweb_rest_url, data, function (resp, status, xhr) {
                if (resp == "1") {
                    chwebr_update_cache();
    ...
    function chwebr_update_cache() {
        var chwebr_url = window.location.href;
        if (chwebr_url.indexOf("?") > -1) {
            chwebr_url += "&chwebr-refresh";
        } else {
            chwebr_url += "?chwebr-refresh";
        }
        var xhr = new XMLHttpRequest();
        xhr.open("GET", chwebr_url, true);
    ...
    $('.onoffswitch').on('click', function () {
        var $parent = $(this).parents('.chwebr-container');
    ...
    if (typeof lashare_fb == "undefined" && typeof chwebr !== 'undefined') {
        $('.chwebicon-facebook').click(function (chwebfb) {
            ...
            chwebfb.preventDefault(chwebfb);
            return false;
        });
    }

    if (typeof chwebr !== 'undefined') {
        $('.chwebicon-twitter').click(function (e) {
            winWidth = 520;
            winHeight = 350;
            var winTop = (screen.height / 2) - (winHeight / 2);
            var winLeft = (screen.width / 2) - (winWidth / 2);
    ...
    if (typeof chwebr !== 'undefined' && chwebr.subscribe === 'content') {
        /* Toogle container display:none */
        jQuery('.chwebicon-subscribe').not('.trigger_active').nearest('.chwebr-toggle-container').hide();
        jQuery('.chwebicon-subscribe').click(function () {
            var trig = jQuery(this);
            if (trig.hasClass('trigger_active')) {
                jQuery(trig).nearest('.chwebr-toggle-container').slideToggle('fast');
                trig.removeClass('trigger_active');
                //jQuery(".chwebicon-subscribe").css({"padding-bottom":"10px"});
            } else {
                jQuery('.trigger_active').nearest('.chwebr-toggle-container').slideToggle('slow');
                jQuery('.trigger_active').removeClass('trigger_active');
                jQuery(trig).nearest('.chwebr-toggle-container').slideToggle('fast');
                trig.addClass('trigger_active');
                //jQuery(".chwebicon-subscribe").css({"padding-bottom":"13px"});
            }
            ;
            return false;
        });
    ...
    if (typeof chwebr !== 'undefined' && chwebr.subscribe === 'link') {
        $('.chwebicon-subscribe').click(function () {
            var href = chwebr.subscribe_url;
            $(this).attr("href", href);
        });
    }
    ;
    ...
    function roundShares(value) {
        if (typeof chwebr !== "undefined" && chwebr.round_shares == 1) {
            if (value > 1000000) {
    ...
    function responsiveButtons()
    {
        ...
        if (chwebr.dynamic_buttons != 1) return;
        
        // Start our Listener
        var listenerContainer = $(".chwebr-container.chwebr-main .chwebr-count");
        ...
        var listenerViews = $(".chwebr-container.chwebr-main .chwebpv .count");
        ...
        var ajaxListener                        = {},
            interval                            = {};
        //$primaryButtons                     = $("aside.chwebr-container.chwebr-main > .chwebr-box > .chwebr-buttons > a[class^='chwebicon-']:visible:not(.secondary-shares a)"),
        //$secondaryShareButtonsContainer     = $("aside.chwebr-container .secondary-shares");
        ...
        // or modified.
        // 2. If the ajax request is done outside of ChwebSocialShare work such as theme customisations
        ...
        function calculate()
        {
            var $container = $("aside.chwebr-container.chwebr-main");

            if ($container.length > 0) {
                $container.each(function() {
                    var $this           = $(this),
                        $primaryButtons = $this.find(".chwebr-box > .chwebr-buttons > .chwebr-primary-shares > a[class^='chwebicon-']:visible");

                    //$this.find(".chwebr-box > .chwebr-buttons > .secondary-shares").css("clear", "both");
        ...
        {
            // Variables
            var $chwebShareContainer             = primaryButtons.parents("aside.chwebr-container.chwebr-main"),
                $container                      = $chwebShareContainer.find(".chwebr-buttons > .chwebr-primary-shares"),
                $shareCountContainer            = $chwebShareContainer.find(".chwebr-box > .chwebr-count:not(.chwebpv)"),
                isShareCountContainerVisible    = ($shareCountContainer.length > 0 && $shareCountContainer.is(":visible")),
                $viewCounterContainer           = $chwebShareContainer.find(".chwebr-box > .chwebpv.chwebr-count"),
     ...
     * 
     */
    if (typeof chwebr !== 'undefined' && chwebr.animate_shares == 1 && $('.chwebrcount').length) {
        $('.chwebrcount').countTo({from: 0, to: chwebr.shares, speed: 1000, refreshInterval: 100});
    }
});
