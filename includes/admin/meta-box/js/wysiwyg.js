...
jQuery( function ( $ )
{
	...
	{
		var $clones = $el.closest( '.chwebr-rwmb-clone' ).siblings( '.chwebr-rwmb-clone' ),
			id = '';
		$clones.each( function ()
		{
			var currentId = $( this ).find( '.chwebr-rwmb-wysiwyg' ).attr( 'id' );
	...
	$( '.chwebr-rwmb-input' ).on( 'clone', ':input.chwebr-rwmb-wysiwyg', update );
} );
