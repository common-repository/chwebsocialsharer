jQuery( document ).ready( function ( $ )
{
	...
	// Add more file
	$( '.chwebr-rwmb-add-file' ).each( function ()
	{
		var $this = $( this ),
			$uploads = $this.siblings( '.file-input' ),
			$first = $uploads.first(),
			uploadCount = $uploads.length,
			$fileList = $this.closest( '.chwebr-rwmb-input' ).find( '.chwebr-rwmb-uploaded' ),
	...
	$( '.chwebr-rwmb-uploaded' ).on( 'click', '.chwebr-rwmb-delete-file', function ()
	{
		var $this = $( this ),
			$parent = $this.parents( 'li' ),
			$container = $this.closest( '.chwebr-rwmb-uploaded' ),
			data = {
		...
		$.post( ajaxurl, data, function ( r )
		{
			...
			$( '.chwebr-rwmb-uploaded' ).on( 'transitionend webkitTransitionEnd otransitionend', 'li.removed', function ()
			{
				$( this ).remove();
				$container.trigger( 'update.rwmbFile' );
			} );
	...
	$( 'body' ).on( 'update.rwmbFile', '.chwebr-rwmb-uploaded', function ()
	{
		var $fileList = $( this ),
			maxFileUploads = $fileList.data( 'max_file_uploads' ),
	...
	// Reorder images
	$( '.chwebr-rwmb-file' ).each( function ()
	{
		var $this = $( this ),
			data = {
