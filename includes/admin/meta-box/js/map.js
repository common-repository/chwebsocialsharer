(function ( $ )
{
	...
	MapField.prototype = {
		...
		{
			this.canvas = this.$container.find( '.chwebr-rwmb-map-canvas' )[0];
			this.$coordinate = this.$container.find( '.chwebr-rwmb-map-coordinate' );
			this.$findButton = this.$container.find( '.chwebr-rwmb-map-goto-address-button' );
	...
	$( function ()
	{
		$( '.chwebr-rwmb-map-field' ).each( function ()
		{
		...
		$( '.chwebr-rwmb-input' ).on( 'clone', function ()
		{
			$( '.chwebr-rwmb-map-field' ).each( function ()
			{
				var field = new MapField( $( this ) );
