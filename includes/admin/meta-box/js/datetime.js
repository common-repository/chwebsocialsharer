jQuery( function ( $ )
{
	...
	if ( $.timepicker.regional.hasOwnProperty( CHWEBR_RWMB_Datetimepicker.locale ) )
	{
		$.timepicker.setDefaults( $.timepicker.regional[CHWEBR_RWMB_Datetimepicker.locale] );
	}
	else if ( $.timepicker.regional.hasOwnProperty( CHWEBR_RWMB_Datetimepicker.localeShort ) )
	{
		$.timepicker.setDefaults( $.timepicker.regional[CHWEBR_RWMB_Datetimepicker.localeShort] );
	}

	$( ':input.chwebr-rwmb-datetime' ).each( update );
	$( '.chwebr-rwmb-input' ).on( 'clone', ':input.chwebr-rwmb-datetime', update );
} );
