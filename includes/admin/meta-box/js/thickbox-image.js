jQuery( function ( $ )
{
	...
	$( 'body' ).on( 'click', '.chwebr-rwmb-thickbox-upload', function ()
	{
		var $this = $( this ),
			$holder = $this.siblings( '.chwebr-rwmb-images' ),
			post_id = $( '#post_ID' ).val(),
		...
		window.send_to_editor = function ( html )
		{
			...
			html = '<li id="item_' + id + '">';
			html += '<img src="' + url + '">';
			html += '<div class="chwebr-rwmb-image-bar">';
			html += '<a class="chwebr-rwmb-delete-file" href="#" data-attachment_id="' + id + '">×</a>';
			html += '</div>';
