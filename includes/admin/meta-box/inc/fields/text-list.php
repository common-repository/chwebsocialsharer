 ...
 */
class CHWEBR_RWMB_Text_List_Field extends CHWEBR_RWMB_Multiple_Values_Field
{
	/**
	 * Get field HTML
	 *
	...
	{
		$html  = array();
		$input = '<label><input type="text" class="chwebr-rwmb-text-list" name="%s" value="%s" placeholder="%s"> %s</label>';
