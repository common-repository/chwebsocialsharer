 ...
 */
class CHWEBR_RWMB_Wysiwyg_Field extends CHWEBR_RWMB_Field
{
	/**
	...
	{
		wp_enqueue_style( 'chwebr-rwmb-wysiwyg', CHWEBR_RWMB_CSS_URL . 'wysiwyg.css', array(), CHWEBR_RWMB_VER );
		wp_enqueue_script( 'chwebr-rwmb-wysiwyg', CHWEBR_RWMB_JS_URL . 'wysiwyg.js', array( 'jquery' ), CHWEBR_RWMB_VER, true );
	}
	...
	static function normalize( $field )
	{
		...
		$field['options'] = wp_parse_args( $field['options'], array(
			'editor_class' => 'chwebr-rwmb-wysiwyg',
