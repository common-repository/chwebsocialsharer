 ...
 */
abstract class CHWEBR_RWMB_Key_Value_Field extends CHWEBR_RWMB_Text_Field
{
	/**
	 * Get field HTML
	 *
	...
	static function begin_html( $meta, $field )
	{
		...
		if ( empty( $field['name'] ) )
			return '<div class="chwebr-rwmb-input">' . $desc;

		return sprintf(
			'<div class="chwebr-rwmb-label">
				<label for="%s">%s</label>
			</div>
			<div class="chwebr-rwmb-input">
			%s',
			$field['id'],
			$field['name'],
			$desc
