 ...
 * oEmbed field class.
 */
class CHWEBR_RWMB_OEmbed_Field extends CHWEBR_RWMB_URL_Field
{
	/**
	...
	{
		wp_enqueue_style( 'chwebr-rwmb-oembed', CHWEBR_RWMB_CSS_URL . 'oembed.css' );
		wp_enqueue_script( 'chwebr-rwmb-oembed', CHWEBR_RWMB_JS_URL . 'oembed.js', array(), CHWEBR_RWMB_VER, true );
	}
