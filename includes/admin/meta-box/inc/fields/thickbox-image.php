 ...
 */
class CHWEBR_RWMB_Thickbox_Image_Field extends CHWEBR_RWMB_Image_Field
{
	/**
	...
	public static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_script( 'chwebr-rwmb-thickbox-image', CHWEBR_RWMB_JS_URL . 'thickbox-image.js', array( 'jquery' ), CHWEBR_RWMB_VER, true );
	}
	...
	public static function html( $meta, $field )
	{
		...
		// Show form upload
		$html .= "<a href='#' class='button chwebr-rwmb-thickbox-upload' data-field_id='{$field['id']}'>{$i18n_title}</a>";
