 ...
 */
class CHWEBR_RWMB_Checkbox_Field extends CHWEBR_RWMB_Input_Field
{
	/**
	...
	{
		wp_enqueue_style( 'chwebr-rwmb-checkbox', CHWEBR_RWMB_CSS_URL . 'checkbox.css', array(), CHWEBR_RWMB_VER );
	}
