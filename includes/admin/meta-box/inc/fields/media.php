 ...
 */
class CHWEBR_RWMB_Media_Field extends CHWEBR_RWMB_Field
{
	/**
	...
	{
		wp_enqueue_media();
		wp_enqueue_style( 'chwebr-rwmb-media', CHWEBR_RWMB_CSS_URL . 'media.css', array(), CHWEBR_RWMB_VER );
		wp_enqueue_script( 'chwebr-rwmb-media', CHWEBR_RWMB_JS_URL . 'media.js', array( 'jquery-ui-sortable', 'underscore', 'backbone' ), CHWEBR_RWMB_VER, true );
		wp_localize_script( 'chwebr-rwmb-media', 'i18nRwmbMedia', array(
			...
			'loadingUrl'         => CHWEBR_RWMB_URL . 'img/loader.gif',
	...
	static function html( $meta, $field )
	{
		...
		$html = sprintf(
			'<input %s>
			<div class="chwebr-rwmb-media-view" data-mime-type="%s" data-max-files="%s" data-force-delete="%s"></div>',
	...
	{
		require_once( CHWEBR_RWMB_INC_DIR . 'templates/media.php' );
	}
}
