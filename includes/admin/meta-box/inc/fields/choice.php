 ...
 */
abstract class CHWEBR_RWMB_Choice_Field extends CHWEBR_RWMB_Field
{
	/**
	 * Walk options
	 *
	...
	{
		$options = call_user_func( array( CHWEBR_RW_Meta_Box::get_class_name( $field ), 'get_options' ), $field );
