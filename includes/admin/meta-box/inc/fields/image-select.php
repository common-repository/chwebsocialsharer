 ...
 */
class CHWEBR_RWMB_Image_Select_Field extends CHWEBR_RWMB_Field
{
	/**
	...
	{
		wp_enqueue_style( 'chwebr-rwmb-image-select', CHWEBR_RWMB_CSS_URL . 'image-select.css', array(), CHWEBR_RWMB_VER );
		wp_enqueue_script( 'chwebr-rwmb-image-select', CHWEBR_RWMB_JS_URL . 'image-select.js', array( 'jquery' ), CHWEBR_RWMB_VER, true );
	}
	...
	{
		$html = array();
		$tpl  = '<label class="chwebr-rwmb-image-select"><img src="%s"><input type="%s" class="hidden" name="%s" value="%s"%s></label>';
