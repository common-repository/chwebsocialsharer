 ...
 * Select field class.
 */
class CHWEBR_RWMB_Select_Field extends CHWEBR_RWMB_Choice_Field
{
	/**
	...
	{
		wp_enqueue_style( 'chwebr-rwmb-select', CHWEBR_RWMB_CSS_URL . 'select.css', array(), CHWEBR_RWMB_VER );
	...
	public static function get_select_all_html( $field )
	{
		...
		{
			return '<div class="chwebr-rwmb-select-all-none">' . __( 'Select', 'meta-box' ) . ': <a data-type="all" href="#">' . __( 'All', 'meta-box' ) . '</a> | <a data-type="none" href="#">' . __( 'None', 'meta-box' ) . '</a></div>';
		}
		return '';
	}
}
