...
class CHWEBR_RWMB_Helper
{
	...
	public static function hash_fields( $post_type )
	{
		...
		$meta_boxes = CHWEBR_RWMB_Core::get_meta_boxes();
		foreach ( $meta_boxes as $meta_box )
		{
			$meta_box = CHWEBR_RW_Meta_Box::normalize( $meta_box );
	...
	public static function find_field( $field_id, $post_id = null )
	{
		...
		return call_user_func( array( CHWEBR_RW_Meta_Box::get_class_name( $field ), 'normalize' ), $field );
	}
	...
	public static function meta( $key, $args = array(), $post_id = null )
	{
		...
		$class = CHWEBR_RW_Meta_Box::get_class_name( $field );
		...
		switch ( $args['type'] )
		{
			...
			case 'map':
				...
				$meta  = CHWEBR_RWMB_Map_Field::the_value( $field, $args, $post_id );
				break;
			case 'oembed':
				$meta = CHWEBR_RWMB_OEmbed_Field::the_value( $field, $args, $post_id );
				break;
			default:
