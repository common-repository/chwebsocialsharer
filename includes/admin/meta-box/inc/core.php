...
class CHWEBR_RWMB_Core
{
	...
	{
		load_plugin_textdomain( 'meta-box', false, plugin_basename( CHWEBR_RWMB_DIR ) . '/lang/' );
	}
	...
	public function register_meta_boxes()
	{
		...
		{
			new CHWEBR_RW_Meta_Box( $meta_box );
		}
	}
	...
	public static function get_meta_boxes()
	{
		...
		{
			self::$meta_boxes = apply_filters( 'chwebr_rwmb_meta_boxes', array() );
