...
class chwebrLogger {
  ...
  const FATAL = 0;
	...
	function __construct($file, $level)
	{
		$this->file = $file;
		$this->level = $level;
		$this->path = CHWEBR_PLUGIN_DIR . "logs/$this->file";
                $this->folder = CHWEBR_PLUGIN_DIR . "logs";
		$this->start();
	}
	...
	private function check_level($level)
	{
	  return $this->level < $level;
        ...
        /* Log - Only when chwebsocialshare debug mode is enabled
         */
	...
	private function write($string)
	{
        ...
        /* Check if chwebsocialshare debug mode is enabled
         * 
         * @return bool
         */
