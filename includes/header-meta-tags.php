...
class CHWEBR_HEADER_META_TAGS {
    ...
    public function get_og_data() {
        $this->og_title = $this->sanitize_data( get_post_meta( $this->postID, 'chwebr_og_title', true ) );
        $this->og_description = $this->sanitize_data( get_post_meta( $this->postID, 'chwebr_og_description', true ) );
        $this->og_image = $this->get_image_url();
        $this->twitter_title = $this->sanitize_data( get_post_meta( $this->postID, 'chwebr_custom_tweet', true ) );
        $this->twitter_creator = $this->get_twitter_creator();
        $this->twitter_site = chwebr_get_twitter_username();
    }
    ...
    /* public function get_og_add_on_data() {
      ...
      $this->addon_twitter_title = htmlspecialchars( get_post_meta( $this->postID, 'chwebog_tw_title', true ) );
      } */
    ...
    public function get_title() {
        //return chwebr_get_document_title();
        return $this->replace_quote_characters( htmlspecialchars_decode( chwebr_get_document_title() ) );
    }
    ...
    /**
     * Get custom open graph image url from chwebr og settings
     * 
     * @return string  
     */
    public function get_image_url() {
        $og_image = get_post_meta( $this->postID, 'chwebr_og_image', true );
        if( $og_image ) {
    ...
    /**
     * Get Pinterst image url from chwebr meta box settings
     * 
     * @return string  
     */
    public function get_pinterest_image_url() {
        $image = get_post_meta( $this->postID, 'chwebr_pinterest_image', true );
    ...
    public function get_pinterest_description() {
        $desc = get_post_meta( $this->postID, 'chwebr_pinterest_description', true );
        if( !empty( $desc ) ) {
            return $desc;
        }
    ...
    public function get_fb_author_url() {
        // CHWEBR facebook author url
        if( get_the_author_meta( 'chwebr_fb_author', $this->get_post_author( $this->postID ) ) ) {
            return get_the_author_meta( 'chwebr_fb_author', $this->get_post_author( $this->postID ) );
        }
    ...
    public function get_twitter_creator() {
        // CHWEBR facebook author url
        $twitter_handle = get_the_author_meta( 'chwebr_twitter_handle', $this->get_post_author( $this->postID ) );
        if( $twitter_handle ) {
    ...
    public function get_fb_publisher_url() {
        ...
        if( !empty( $chwebr_options['fb_publisher_url'] ) ) {
            return $chwebr_options['fb_publisher_url'];
        }
    ...
    public function get_fb_app_id() {
        global $chwebr_options;
        if( !empty( $chwebr_options['fb_app_id'] ) ) {
            return $chwebr_options['fb_app_id'];
        }
    ...
    public function is_twitter_card() {
        global $chwebr_options;
        if( isset( $chwebr_options['twitter_card'] ) ) {
            return true;
        }
    }

    /**
     * Check if chwebsocialshare open graph meta tags are enabled
     * 
     * @global array $chwebr_options
     * @return boolean
     */
    public function is_open_graph() {
        global $chwebr_options;
        if( isset( $chwebr_options['open_graph'] ) ) {
            return true;
        }
    }
    ...
    public function render_open_graph_meta() {
        ...
        $opengraph = PHP_EOL . '<!-- Open Graph Meta Tags generated by ChwebSocialShare ' . CHWEBR_VERSION . ' - https://chaudharyweb.com -->';
        ...
        $opengraph .= PHP_EOL . '<!-- Open Graph Meta Tags generated by ChwebSocialShare ' . CHWEBR_VERSION . ' - https://www.chaudharyweb.com -->';
    ...
    public function render_twitter_card_meta() {
        ...
        $twittercard = PHP_EOL . '<!-- Twitter Card generated by ChwebSocialShare ' . CHWEBR_VERSION . ' - https://www.chaudharyweb.com -->';
        ...
        $twittercard .= PHP_EOL . '<!-- Twitter Card generated by ChwebSocialShare ' . CHWEBR_VERSION . ' - https://www.chaudharyweb.com -->' . PHP_EOL . PHP_EOL;
        return $twittercard;
    }
    ...
    public function render_header_meta() {
        //echo apply_filters( 'chwebr_meta_tags', $html );
        echo apply_filters( 'chwebr_opengraph_meta', $this->render_open_graph_meta() );
        echo apply_filters( 'chwebr_twittercard_meta', $this->render_twitter_card_meta() );
    }
 ...
 * 
 * @global CHWEBR_HEADER_META_TAGS $chwebr_meta_tags
 * @return object
 */
function chwebr_meta_tags_init() {
    global $chwebr_meta_tags;

    if( !is_null( $chwebr_meta_tags ) ) {
        return $chwebr_meta_tags;
    }

    $chwebr_meta_tags = new CHWEBR_HEADER_META_TAGS();
    return $chwebr_meta_tags;
}

add_action( 'wp_head', 'chwebr_meta_tags_init', 1 );
