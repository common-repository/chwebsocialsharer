...
/**
 * @file
 * Simple PHP class for interacting with the v3 bit.ly api (only deals with
 ...
 * @author Rajesh Chaudhary <info@chaudharyweb.com>
 */
class chwebr_bitly_shorturl {
    
    // The URI of the bitly OAuth endpoints.
    private $bitly_oauth_api;
     ...
     *   Array of fields to send.
     */
    private function bitly_post_curl($uri, $fields, $header_array = array()) {
        $output = "";
        $fields_string = "";
